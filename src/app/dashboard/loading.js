export default function Loading() {
  return (
    <div className='flex flex-col flex-1 animate-pulse'>
      ...
      <ul className='grid pb-10 mt-4 xl:grid-cols-2 xl:grid-rows-3 sm:mt-6 xl:gap-x-8 gap-y-3 sm:gap-y-5'>
        <ListItem />
        <ListItem />
        <ListItem />
        <ListItem />
...
function ListItem() {
  return (
    <li className='flex items-center gap-3 last:hidden xl:last:flex'>
