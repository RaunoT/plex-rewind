...
function Loader() {
  return (
    ...
    >
      ...
      <span className='animation-delay-300 size-1 animate-pulse rounded-full bg-white' />
      <span className='animation-delay-700 size-1 animate-pulse rounded-full bg-white' />
    </motion.div>
  )
}
